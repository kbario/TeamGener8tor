...
class Engineer extends Employee {
    ...
    createHTML() {
        ...
        <div class="card-header engineer-header">
            <h1 class="text-3xl mb-1">${this.getName()}</h1>
        ...
        <div class="card-body">
            <div class="card-info engineer-info">
                ...
                <a href="mailto:${this.getEmail()}" class="card-info-section engineer-info-section border-y border-y-slate-600">
                    <p class="card-info-section-header">Email</p>
                    <p>${this.getEmail()}</p>
                </a>
                <a href="http://github.com/${this.getGithub()}" target="_blank" class="card-info-section engineer-info-section">
